...
const getVideoComments = asyncHandler(async (req: RequestUser, res: Response) => {
...
const addComment = asyncHandler(async (req: RequestUser, res: Response) => {
...
const updateComment = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!newComment) {
        throw new ApiError(
            500,
            "Invalid Comment Id or Error while editing comment",
        );
    }
    return res
        .status(200)
